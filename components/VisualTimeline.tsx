        ...
        {targetApps.length === 0 ? (
          ...
          <div className={`absolute inset-0 bg-white pointer-events-none ${isLarge ? '' : 'rounded-xl'} overflow-hidden`}>
            ...
            >
              ...
              <path fill="#06b6d4" opacity="0.5" d="M0 40 Q 25 30 50 40 T 100 40 V 65 Q 75 55 50 65 T 0 65 Z">
              ...
              {/* 波 2: スカイブルー系 */}
              <path fill="#3b82f6" opacity="0.5" d="M0 45 Q 25 55 50 45 T 100 45 V 58 Q 75 65 50 58 T 0 58 Z">
              ...
              {/* 波 3: バイオレット系 */}
              <path fill="#8b5cf6" opacity="0.4" d="M0 35 Q 25 20 50 35 T 100 35 V 70 Q 75 80 50 70 T 0 70 Z">
